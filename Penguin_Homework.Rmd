...
write.csv (penguins_raw, here("data","penguins_raw.csv")) #This saves the data to a file called data, saved in the same R project as this rmd file. If re-running this code, a file named data will be necessary in the same working directory.  
...
[My Git Hub Repository](https://github.com/Tsavoboi/Homework_For_Palmers_Penguins)
